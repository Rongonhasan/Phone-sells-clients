...
const AddProduct = () => {
    ...
    const handleAddProduct = (data) => {
        ...
        const url = `https://api.imgbb.com/1/upload?key=${'4e7a06fce075a5cf2890c99aac77b88e'}`
        fetch(url, {
            method: 'POST',
            body: formData,
        }).then(res => res.json())
    ...
    return (
        <div className='w-96 shadow-lg p-2 md:ml-44 md:mx-auto mt-20'>
            <div className='w-96 p-5 shadow-lg rounded-lg' >
                ...
                <form onSubmit={handleSubmit(handleAddProduct)}>
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        <select  defaultValue={'Apple'} {...register("category", { required: "Please Select Category" })} className="select select-primary text-black w-full max-w-xs">
